...
void FillRandVectors(std::vector< double > &xVector,
                     std::vector< double > &yVector,
                     std::vector< double > &xErrorVector, 	 			     std::vector< double > &yErrorVector, int n)
{
    //Call TRandom3
    ...
    for(int i =0; i<n; i=i+1)
    {
        ...
        yVector.push_back(jrand->Uniform(20.0));
